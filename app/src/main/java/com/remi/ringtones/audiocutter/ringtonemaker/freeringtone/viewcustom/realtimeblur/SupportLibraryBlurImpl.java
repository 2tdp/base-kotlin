...
public class SupportLibraryBlurImpl implements BlurImpl {
    ...
    @Override // com.remi.equalizerfx.bassbooster.virtrualizer.view.customview.realtimeblur.BlurImpl
    ...
    static boolean isDebug(Context context) {
        if (DEBUG == null && context != null) DEBUG = (context.getApplicationInfo().flags & 2) != 0;
